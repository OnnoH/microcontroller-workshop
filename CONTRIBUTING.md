...
This repository aims to collect everything related to microcontrollers. Please share your thoughts, links, designs, code herein.

Since this is a project with growth potential, every idea is welcome no matter how crazy (well there's a limit on what can be achieved of course). So if you want to add a sensor, switch type, sample sketch, etc. etc., just get started.
